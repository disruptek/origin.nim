...
suite "vec3":
  ...
  test "rand":
    ...
    check Vec3.rand.allIt(it >= 0 and it <= 1)
    check Vec3.rand(50f..100f).allIt(it >= 50 and it <= 100)
  ...
  test "clamp":
    var a = vec3()
    let b = vec3(-1.5, 0.3, 1.2)
    check a.clamp(b) == b
    check a.clamp(b, 0f..1f) == vec3(0, 0.3, 1)
    check a.clamp(b, -1.5f..0f) == vec3(-1.5, 0, 0)
    check a.clamp(b, 0f..0.1f) == vec3(0, 0.1, 0.1)
    check b.clamp == b
    check b.clamp(0f..1f) == vec3(0, 0.3, 1)
    check b.clamp(-1.5f..0f) == vec3(-1.5, 0, 0)
    check b.clamp(0f..0.1f) == vec3(0, 0.1, 0.1)

  test "+":
    var a = vec3()
    let b = vec3(0.41, -0.87, 0.12)
    check `+`(a, b, vec3(0.11, 0.42, 0.31)) ~= vec3(0.52, -0.45, 0.43)
    check `+`(a, b, vec3()) == b
    check `+`(a, vec3(), b) == b
    check b + vec3(0.11, 0.42, 0.31) ~= vec3(0.52, -0.45, 0.43)
    check b + vec3() == b
    check vec3() + b == b

  test "-":
    var a = vec3()
    let b = vec3(-0.16, -0.72, 0.55)
    check `-`(a, b, vec3(-0.69, 0.61, 0.23)) ~= vec3(0.53, -1.33, 0.32)
    check `-`(a, b, vec3()) == b
    check b - vec3(-0.69, 0.61, 0.23) ~= vec3(0.53, -1.33, 0.32)
    check b - vec3() == b
  ...
  test "* (hadamard)":
    ...
    check `*`(a, b, c) ~= vec3(-0.4092, 0.1701, 0.1232)
    check `*`(a, b, vec3()) == vec3()
    check `*`(a, vec3(), b) == vec3()
  ...
  test "* (scalar)":
    var a = vec3()
    check `*`(a, vec3(0.82, -0.53, 0.1), 0.94) ~= vec3(0.7708, -0.4982, 0.094)
  ...
  test "/ (hadamard)":
    ...
    check `/`(a, b, c) ~= vec3(2.9375, 2.352941, 0.177083)
    check `/`(a, b, vec3()) == vec3()
    check `/`(a, vec3(), c) == vec3()
  ...
  test "/ (scalar)":
    var a = vec3()
    check `/`(a, vec3(0.54, -0.12, 0.75), 0.23) ~= vec3(2.347826, -0.521739, 3.260870)
    check vec3(0.54, -0.12, 0.75) / 0.23 ~= vec3(2.347826, -0.521739, 3.260870)

  test "^":
    var a = vec3()
    let b = vec3(0.81, 0.32, 0.33)
    check `^`(a, b, 2.2) ~= vec3(0.629024, 0.081532, 0.087243)
  ...
  test "sign":
    var a = vec3()
    check a.sign(vec3()) == vec3()
    check a.sign(vec3(10)) == vec3(1)
    check a.sign(vec3(-10)) == vec3(-1)
    check a.sign(vec3(10, -10, 10)) == vec3(1, -1, 1)
  ...
  test "fract":
    var a = vec3()
    check a.fract(vec3()) == vec3()
    check a.fract(vec3(10.42)) ~= vec3(0.42)
    check a.fract(vec3(-10.42)) ~= vec3(0.58)
    check a.fract(vec3(10.42, -10.42, 10.42)) ~= vec3(0.42, 0.58, 0.42)
  ...
  test "sqrt":
    var a = vec3()
    check a.sqrt(vec3(49, 9, 16)) == vec3(7, 3, 4)
  ...
  test "normalize":
    var a = vec3()
    check a.normalize(vec3(-0.65, 0.23, -0.1)) ~= vec3(-0.932961, 0.330125, -0.143532)
    check a.normalize(vec3(2, 0, 0)) == vec3(1, 0, 0)
    check a.normalize(vec3(0, 2, 0)) == vec3(0, 1, 0)
    check a.normalize(vec3(0, 0, 2)) == vec3(0, 0, 1)
    check a.normalize(vec3()) == vec3()
  ...
  test "round":
    var a = vec3()
    check a.round(vec3(-0.70, 0.36, -1.2)) == vec3(-1, 0, -1)
    check a.round(vec3(-0.3, 0.2, 0.4)) == vec3()
    check vec3(-0.70, 0.36, -1.2).round == vec3(-1, 0, -1)
    check vec3(-0.3, 0.2, 0.4).round == vec3()

  test "floor":
    var a = vec3()
    check a.floor(vec3(-0.1, 0.9, 0.4)) == vec3(-1, 0, 0)
    check a.floor(vec3(-0.3, -1.1, 1.9)) == vec3(-1, -2, 1)
    check vec3(-0.1, 0.9, 0.4).floor == vec3(-1, 0, 0)
    check vec3(-0.3, -1.1, 1.9).floor == vec3(-1, -2, 1)

  test "ceil":
    var a = vec3()
    check a.ceil(vec3(-0.2, 0.1, 1.01)) == vec3(0, 1, 2)
    check a.ceil(vec3(0.9, 1.1, -0.2)) == vec3(1, 2, 0)
    check vec3(-0.2, 0.1, 1.01).ceil == vec3(0, 1, 2)
    check vec3(0.9, 1.1, -0.2).ceil == vec3(1, 2, 0)

  test "abs":
    var a = vec3()
    check a.abs(vec3(-0.42, 0.52, -0.2)) == vec3(0.42, 0.52, 0.2)
    check vec3(-0.42, 0.52, -0.2).abs == vec3(0.42, 0.52, 0.2)

  test "min":
    var a = vec3()
    check a.min(vec3(0.98, 0.06, 0.21), vec3(0.87, 0.25, 0.34)) == vec3(0.87, 0.06, 0.21)
    check vec.min(vec3(0.98, 0.06, 0.21), vec3(0.87, 0.25, 0.32)) == vec3(0.87, 0.06, 0.21)

  test "max":
    var a = vec3()
    check a.max(vec3(0.64, 0.38, 0.34), vec3(0.63, 0.52, 0.22)) == vec3(0.64, 0.52, 0.34)
    check vec.max(vec3(0.64, 0.38, 0.34), vec3(0.63, 0.52, 0.22)) == vec3(0.64, 0.52, 0.34)

  test "mod":
    var a = vec3()
    check a.mod(vec3(0.34, 0.72, 0.23), 0.1) ~= vec3(0.04, 0.02, 0.03)
    check vec3(0.34, 0.72, 0.23) mod 0.1 ~= vec3(0.04, 0.02, 0.03)

  test "sin":
    var a = vec3()
    check a.sin(vec3(Pi/2, Pi/4, Pi/3)) ~= vec3(1, 0.707107, 0.866025)
    check sin(vec3(Pi/2, Pi/4, Pi/3)) ~= vec3(1, 0.707107, 0.866025)

  test "cos":
    var a = vec3()
    check a.cos(vec3(Pi/2, Pi/4, Pi/3)) ~= vec3(0, 0.707107, 0.5)
    check cos(vec3(Pi/2, Pi/4, Pi/3)) ~= vec3(0, 0.707107, 0.5)

  test "tan":
    var a = vec3()
    check a.tan(vec3(Pi/3)) ~= vec3(3).sqrt
    check a.tan(vec3(Pi)) ~= vec3()
    check tan(vec3(Pi/3)) ~= vec3(3).sqrt
    check tan(vec3(Pi)) ~= vec3()

  test "asin":
    var a = vec3()
    check a.asin(vec3(1)) ~= vec3(Pi/2)
    check a.asin(vec3()) ~= vec3()
    check asin(vec3(1)) ~= vec3(Pi/2)
    check asin(vec3()) ~= vec3()

  test "acos":
    var a = vec3()
    check a.acos(vec3(0)) ~= vec3(Pi/2)
    check a.acos(vec3(0.5)) ~= vec3(Pi/3)
    check acos(vec3(0)) ~= vec3(Pi/2)
    check acos(vec3(0.5)) ~= vec3(Pi/3)

  test "atan":
    var a = vec3()
    check a.atan(vec3(1)) ~= vec3(Pi/4)
    check a.atan(vec3(3).sqrt) ~= vec3(Pi/3)
    check atan(vec3(1)) ~= vec3(Pi/4)
    check atan(vec3(3).sqrt) ~= vec3(Pi/3)

  test "radians":
    var a = vec3()
    check a.radians(vec3(90, 60, 45)) ~= vec3(Pi/2, Pi/3, Pi/4)
    check radians(vec3(90, 60, 45)) ~= vec3(Pi/2, Pi/3, Pi/4)

  test "degrees":
    var a = vec3()
    check a.degrees(vec3(Pi/2, Pi/3, Pi/4)) ~= vec3(90, 60, 45)
  ...
  test "lerp":
    ...
    check a.lerp(b, c, 0.5) ~= vec3(0.465, 0.535, 0.28)
    check a.lerp(b, c, 0) == vec3(0.74, 0.09, 0.22)
    check a.lerp(b, c, 1) == vec3(0.19, 0.98, 0.34)
  ...
  test "cross":
    var a = vec3()
    check a.cross(vec3(1, 0, 0), vec3(0, 1, 0)) == vec3(0, 0, 1)
    check a.cross(vec3(1, 0, 0), vec3(0, 0, 1)) == vec3(0, -1, 0)
    check a.cross(vec3(0, 1, 0), vec3(1, 0, 0)) == vec3(0, 0, -1)
    check a.cross(vec3(0, 1, 0), vec3(0, 0, 1)) == vec3(1, 0, 0)
    check a.cross(vec3(0, 0, 1), vec3(1, 0, 0)) == vec3(0, 1, 0)
    check a.cross(vec3(0, 0, 1), vec3(0, 1, 0)) == vec3(-1, 0, 0)
